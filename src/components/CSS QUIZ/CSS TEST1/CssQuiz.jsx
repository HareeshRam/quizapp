...
import Question from "./CssQuestion";
import questionsData from "./CssQuestions";
import Styles from './cssQuiz.module.css'
function CssQuiz() {
  ...
  if (quizCompleted) {
    if (score >= questionsData.length * 0.9) {
      message = "You are excellent in CSS 👍";
    } else if (score >= questionsData.length * 0.7) {
      message = "You are just good in CSS 😉";
    } else if (score < questionsData.length * 0.5) {
      message = "You are poor in CSS. Please learn more 😔 ";
    }
  }
