...
import Styles from './reactQuestion.module.css'

function ReactQuestion({id, question, options, selected, onSelect, onTimeout, questionNumber }) {
  const [timer, setTimer] = useState(1200); // Set the timer to 25 minutes (1500 seconds)
